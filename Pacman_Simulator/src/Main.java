...
public class Main {
	...
	public static void main (String args[]) throws IOException {
		...
		System.out.println("- MOVE command resulting in Pacman going off the grid wil be ignored");
		System.out.println("====================================================================================================\n");
		...
		GamePlay myGame = new GamePlay(GRID_X_DIMENSION, GRID_Y_DIMENSION, DIRECTION_LIST); 
